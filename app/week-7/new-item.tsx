...
import handleAddItem from "./page";
...
type Props = {
  items: OnAdditem[];
  handleAddItem: (items: OnAdditem) => any;
};

export default function NewItem({ items, handleAddItem }: Props) {
  ...
  return (
    <div className="flex flex-col place-content-center items-center  bg-cyan-900">
      <div className="flex flex-row justify-items-center">
        ...
        <h1 className="flex p-2 mt-8 font-bold text-xl ">
